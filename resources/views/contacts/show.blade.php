                        ...
                        <div class="container px-5 mx-auto">
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <form method="post" id="delete_{{ $contact->id }}" class="mt-40" action="{{ route('contacts.destroy', ['id' => $contact->id ])}}">
                                        @csrf
                                        <div class="p-2 w-full">
                                            <a onclick="deletePost(this)" data-id='{{ $contact->id }}' style="background-color: red" class="flex mx-auto text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg">
                                                削除する
                                            </a>
                                        </div>
                                    </form>
